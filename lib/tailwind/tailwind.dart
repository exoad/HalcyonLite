import 'package:halcyon/tailwind/tailwind_player.dart';
import 'package:flutter/material.dart';

/// Represents a standard
const TDurationUnknown = Duration(days: -1, hours: -1, minutes: -1, seconds: -1, milliseconds: -1, microseconds: -1);
...
final T_supportedFormats = List.unmodifiable(<TAudioFileFormatInfo>[
